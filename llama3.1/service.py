...
ENGINE_CONFIG = CONSTANTS["vllm_engine_args"]
SERVICE_ARGS = CONSTANTS["bentoml_service_args"]
...
@bentoml.service(**SERVICE_ARGS)
class VLLM:
    llama3_1 = HuggingFaceModel(ENGINE_CONFIG["model"])
    ...
    def __init__(self) -> None:
        ...
        ENGINE_CONFIG["model"] = self.llama3_1
